...
//            selectedItems: $scope.mySelections,
        ...
        return {
            restrict: 'E',
            template: '<div style="height: 30px;"> <a> <i class="icon-search" ng-click="showSearchFN()">&nbsp;&nbsp;&nbsp;Search</i> </a>' +
                '<input type="button" name="sendMail"  value="Send Mail" ng-click="sendMail()" class="btn btn-mini btn-info " style="border-top-width: 0px;border-right-width: 0px;border-left-width: 0px;border-bottom-width: 0px;padding-right: 2px;padding-left: 2px;"/></div>' +
...
//            $templateCache:'menuTemplate.html',
            ...
            controller: ('myGridController', function ($scope, $element, $attrs) {
                ...
                $scope.save = function (columns) {
                    ...
                    $http.post(attrs.ajaxMenuDef + '?columnsField=' + JSON.stringify(columnsField), {headers: {'Content-Type': 'application/x-www-form-urlencoded'}}
...
//======================================================= EXTRA METHODS =========================================
                ...
                $scope.showPopup = function (id, bool) {
                    debugger;
                    $scope.$emit('showPopup', id, bool);
